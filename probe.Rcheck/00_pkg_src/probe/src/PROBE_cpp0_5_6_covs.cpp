...
// [[Rcpp::export]]
List PROBE_cpp0_5_6_covs(const arma::vec y, const arma::mat Z, const arma::colvec Wt, 
                    const arma::colvec W_var, const arma::colvec delta, 
                    const arma::colvec beta_vec, const arma::mat Z2, double sigma2, const arma::mat X) {

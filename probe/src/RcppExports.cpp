...
List PROBE_cpp0_5_6_covs_h(const arma::vec y, const arma::mat Z, const arma::colvec Wt, const arma::colvec W_var, const arma::colvec delta, const arma::colvec beta_vec, const arma::mat Z2, const arma::mat X, const arma::mat Sigma_y_inv);
RcppExport SEXP _probe_PROBE_cpp0_5_6_covs_h(SEXP ySEXP, SEXP ZSEXP, SEXP WtSEXP, SEXP W_varSEXP, SEXP deltaSEXP, SEXP beta_vecSEXP, SEXP Z2SEXP, SEXP XSEXP, SEXP Sigma_y_invSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const arma::vec >::type y(ySEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(PROBE_cpp0_5_6_covs_h(y, Z, Wt, W_var, delta, beta_vec, Z2, X, Sigma_y_inv));
    return rcpp_result_gen;
END_RCPP
}
// PROBE_cpp0_5_6_h
List PROBE_cpp0_5_6_h(const arma::vec y, const arma::mat Z, const arma::colvec Wt, const arma::colvec W_var, const arma::colvec delta, const arma::colvec beta_vec, const arma::mat Z2, const arma::mat Sigma_y_inv);
RcppExport SEXP _probe_PROBE_cpp0_5_6_h(SEXP ySEXP, SEXP ZSEXP, SEXP WtSEXP, SEXP W_varSEXP, SEXP deltaSEXP, SEXP beta_vecSEXP, SEXP Z2SEXP, SEXP Sigma_y_invSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const arma::vec >::type y(ySEXP);
    ...
    Rcpp::traits::input_parameter< const arma::mat >::type Z2(Z2SEXP);
    Rcpp::traits::input_parameter< const arma::mat >::type Sigma_y_inv(Sigma_y_invSEXP);
    rcpp_result_gen = Rcpp::wrap(PROBE_cpp0_5_6_h(y, Z, Wt, W_var, delta, beta_vec, Z2, Sigma_y_inv));
    return rcpp_result_gen;
END_RCPP
}
// PROBE_one_cpp
...
RcppExport SEXP _probe_LM_by_col_h(SEXP ySEXP, SEXP XSEXP, SEXP Sigma_y_invSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const arma::vec >::type y(ySEXP);
    Rcpp::traits::input_parameter< const arma::mat >::type X(XSEXP);
    Rcpp::traits::input_parameter< const arma::mat >::type Sigma_y_inv(Sigma_y_invSEXP);
    rcpp_result_gen = Rcpp::wrap(LM_by_col_h(y, X, Sigma_y_inv));
    return rcpp_result_gen;
END_RCPP
}
// LM_w_COVS_by_col
...
RcppExport SEXP _probe_LM_w_COVS_by_col_h(SEXP ySEXP, SEXP XSEXP, SEXP COVSSEXP, SEXP Sigma_y_invSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const arma::vec >::type y(ySEXP);
    ...
    Rcpp::traits::input_parameter< const arma::mat >::type COVS(COVSSEXP);
    Rcpp::traits::input_parameter< const arma::mat >::type Sigma_y_inv(Sigma_y_invSEXP);
    rcpp_result_gen = Rcpp::wrap(LM_w_COVS_by_col_h(y, X, COVS, Sigma_y_inv));
    return rcpp_result_gen;
END_RCPP
}
// MVM
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_probe_PROBE_cpp0_5_6_covs_h", (DL_FUNC) &_probe_PROBE_cpp0_5_6_covs_h, 9},
    {"_probe_PROBE_cpp0_5_6_h", (DL_FUNC) &_probe_PROBE_cpp0_5_6_h, 8},
    ...
    {"_probe_LM_by_col_h", (DL_FUNC) &_probe_LM_by_col_h, 3},
    {"_probe_LM_w_COVS_by_col", (DL_FUNC) &_probe_LM_w_COVS_by_col, 4},
    {"_probe_LM_w_COVS_by_col_h", (DL_FUNC) &_probe_LM_w_COVS_by_col_h, 4},

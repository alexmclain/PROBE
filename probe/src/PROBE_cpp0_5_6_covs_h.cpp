...
List PROBE_cpp0_5_6_covs_h(const arma::vec y, const arma::mat Z, const arma::colvec Wt, 
  ...
  for(int col=0;col<d; ++col){
    ...
    if(bXXt2.is_sympd()){
      ...
      // Updating beta
      //arma::colvec t_beta_tmp1 = XXt_inv*arma::trans(bXt);
      //arma::colvec t_beta_tmp2 = Sigma_y_inv*y;
      arma::colvec t_beta = XXt_inv*arma::trans(bXt)*Sigma_y_inv*y;

      // Estimating the covariance of beta and their SE's
      arma::mat Vbt = arma::diagvec(arma::trans(XXt_inv)*(bXXt2)*XXt_inv);
